    ...
    return (
             <section className="max-w-7xl mx-auto mt-20 ">
                ...
                {[...Array(5)].map((_, index) => (
                    ...
                    <div className="mx-auto w-full bg-green-300">
                        <InfiniteMarquee items={marqueeItems} />
                    </div>
           
                     <Link href="/products">
                        <button className={`group btn rounded-lg py-5.5 px-15 bg-green-600 hover:bg-green-800 outline-2  transtion-all duration-200 font-semibold text-white flex`}>
...
<div className="relative hidden w-full pt-10 px-4">
